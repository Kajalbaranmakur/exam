...
Online Examination System developed for an Educational Institute of West Bengal.
...
```
Local Disc C: -> xampp -> htdocs -> 'Project name(exam)'
```
...
>e.g. *http://localhost:/name-of-project-folder/admin*
2. Login with the Username and Password 
>*[Username: admin, Password: admin]*
3. Hello! You're logged in. Now you can manage categories, posts and users.
